...
PUBLIC int do_fork()
{
	...
	*p = proc_table[pid];
	...
	// 		       4096 : 1));
	// unsigned long long caller_T_size  = (((unsigned long long)caller_T_limit + 1) *
	// 		      ((ppd->limit_high_attr2 & (DA_LIMIT_4K >> 8)) ?
	// 		       4096 : 1));
	// int caller_T_size;
	// if(ppd->limit_high_attr2 & (DA_LIMIT_4K >> 8))
	// {
	// 	caller_T_size = (caller_T_limit + 1) * 4096;
	// }
	// else
	// {
	// 	caller_T_size = caller_T_limit + 1;
	// }

	// using the following instead of the last segment
	// will solve the problem that fork() fails and the system stucks
	int caller_T_size = caller_T_limit + 1;
	...
	// 			((ppd->limit_high_attr2 & (DA_LIMIT_4K >> 8)) ?
	// 			 4096 : 1));
	// unsigned long long caller_D_S_size  = (((unsigned long long)caller_T_limit + 1) *
	// 			((ppd->limit_high_attr2 & (DA_LIMIT_4K >> 8)) ?
	// 			 4096 : 1));
	// int caller_D_S_size;
	// if(ppd->limit_high_attr2 & (DA_LIMIT_4K >> 8))
	// {
	// 	caller_D_S_size = (caller_T_limit + 1) * 4096;
	// }
	// else
	// {
	// 	caller_D_S_size = caller_T_limit + 1;
	// }
